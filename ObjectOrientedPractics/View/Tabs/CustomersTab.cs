...
namespace ObjectOrientedPractics.View.Tabs
{
    ...
    partial class CustomersTab : UserControl
    {
        ...
        {
            _customers.Add(new Customer("Fullname", "Address", idGenerator.GetNextId()));
            binding.ResetBindings(false);
        ...
        /// <summary>
        /// Обработчик события изменения текста в текстбоксе адреса покупателя.
        /// </summary>
        private void AddressTextBox_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (CustomersListBox.SelectedValue != null)
                {
                    ((Customer)CustomersListBox.SelectedItem).Address = AddressTextBox.Text;
                }
